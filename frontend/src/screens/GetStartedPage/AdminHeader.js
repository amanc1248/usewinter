    ...
    <div className="">
      ...
      <Navbar expand="lg" bg="#F2EBD1" className="the__navbar">
        <Navbar.Brand href="/" className={"navbar__brand"}>
          <img
            src="https://renderer-v2.vercel.app/_next/image?url=https%3A%2F%2Fapi.typedream.com%2Fv0%2Fdocument%2Fpublic%2F4df266b4-fb1b-4f46-922b-fa0c3eda45d1_g10_1_png.png%3Fbucket%3Ddocument&w=384&q=75"
            alt="winter"
            height="50px"
          />
          winter
